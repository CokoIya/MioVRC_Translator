"""Repack the release directory into a zip archive and self-verify the bundle."""
...
src = REPO_ROOT / "dist" / "MioTranslator"
exe = src / "MioTranslator.exe"
out = REPO_ROOT / "dist" / "MioTranslator-windows-x64.zip"

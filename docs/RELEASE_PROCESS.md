...
Expected `v1.3.9.3` assets:

- `dist\MioTranslator-Setup-v1.3.9.3.exe`
- `mio_update.json`
- `docs\installer_manifest.json`
- `docs\release_signing_keys.json`
- `dist\MioTranslator-v1.3.9.3-SHA256SUMS.txt`
- `dist\MioTranslator-v1.3.9.3-SHA256SUMS.txt.sig.json`
...
git push origin v1.3.9.3
```

The GitHub Release must be tagged `v1.3.9.3` and must upload the installer,
...
that name. Use `docs/RELEASE_NOTES_v1.3.9.3.md` as the release body.
